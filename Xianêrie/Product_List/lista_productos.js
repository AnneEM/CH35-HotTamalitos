...
listaProductos.forEach(producto => {
  ...
  if (contenedor) {
    ...
    if (producto.id_producto % 2 !== 0) {
      nuevoElemento.innerHTML = `
        <!-- Estructura HTML de cada producto para id_producto impares -->
        <div class="item-producto">
          ...
          <div class="bttn">
            <button type="button" class="button-carrito btn--solidbk" onclick="agregarAlCarrito(${producto.id_producto})">
            Agregar al carrito
            </button>
          </div>
        </div>
      ...
      nuevoElemento.innerHTML = `
        <!-- Estructura HTML de cada producto para id_producto pares -->
        <div class="item-producto">
          <div class="texto">
            <h3>${producto.nombre}</h3>
            <p>${producto.descripcion}<br>
...
function agregarAlCarrito(idProducto) {
  ...
  if (producto) {
    ...
    // Alerta de producto agregado // C A M B I A R por otro mensaje
